...
class AboutApi
{
     ...
     * @return \OpenAPI\Client\Model\AboutResponse
     */
    public function getAbout($lang = null, string $contentType = self::contentTypes['getAbout'][0])
    {
        list($response) = $this->getAboutWithHttpInfo($lang, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AboutResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAboutWithHttpInfo($lang = null, string $contentType = self::contentTypes['getAbout'][0])
    {
        $request = $this->getAboutRequest($lang, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\AboutResponse',
                        $request,
                        $response,
                    );
            }
     ...
     */
    public function getAboutAsync($lang = null, string $contentType = self::contentTypes['getAbout'][0])
    {
        return $this->getAboutAsyncWithHttpInfo($lang, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAboutAsyncWithHttpInfo($lang = null, string $contentType = self::contentTypes['getAbout'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AboutResponse';
        $request = $this->getAboutRequest($lang, $contentType);
     ...
     */
    public function getAboutRequest($lang = null, string $contentType = self::contentTypes['getAbout'][0])
    {
