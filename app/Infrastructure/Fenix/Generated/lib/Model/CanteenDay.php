 ...
 */
class CanteenDay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CanteenDay';
    ...
    protected static $openAPITypes = [
        'day' => 'string',
        'meal' => '\OpenAPI\Client\Model\CanteenMeal[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('meal', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets meal
     *
     * @return \OpenAPI\Client\Model\CanteenMeal[]|null
     */
     ...
     * Sets meal
     *
     * @param \OpenAPI\Client\Model\CanteenMeal[]|null $meal meal
     *
     * @return self
     */
    ...
    {
        if (is_null($meal)) {
            throw new \InvalidArgumentException('non-nullable meal cannot be null');
        }
