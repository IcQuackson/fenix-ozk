...
/**
 * CourseCompetence Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseCompetence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseCompetence';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'program' => 'string',
        'bibliographic_references' => '\OpenAPI\Client\Model\BibliographicReference[]',
        'degrees' => '\OpenAPI\Client\Model\DegreeRef[]'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'program' => 'setProgram',
        'bibliographic_references' => 'setBibliographicReferences',
        'degrees' => 'setDegrees'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'program' => 'getProgram',
        'bibliographic_references' => 'getBibliographicReferences',
        'degrees' => 'getDegrees'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bibliographic_references', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets bibliographic_references
     *
     * @return \OpenAPI\Client\Model\BibliographicReference[]|null
     */
    public function getBibliographicReferences()
    {
        return $this->container['bibliographic_references'];
    }

    /**
     * Sets bibliographic_references
     *
     * @param \OpenAPI\Client\Model\BibliographicReference[]|null $bibliographic_references bibliographic_references
     *
     * @return self
     */
    public function setBibliographicReferences($bibliographic_references)
    {
        if (is_null($bibliographic_references)) {
            throw new \InvalidArgumentException('non-nullable bibliographic_references cannot be null');
        }
        $this->container['bibliographic_references'] = $bibliographic_references;
     ...
     * Sets degrees
     *
     * @param \OpenAPI\Client\Model\DegreeRef[]|null $degrees degrees
     *
     * @return self
     */
