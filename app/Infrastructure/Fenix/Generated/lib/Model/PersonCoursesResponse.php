...
/**
 * PersonCoursesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PersonCoursesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonCoursesResponse';
    ...
    protected static $openAPITypes = [
        'enrolments' => '\OpenAPI\Client\Model\PersonCoursesResponseEnrolmentsInner[]',
        'teaching' => '\OpenAPI\Client\Model\EvaluationCoursesInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('teaching', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets enrolments
     *
     * @return \OpenAPI\Client\Model\PersonCoursesResponseEnrolmentsInner[]|null
     */
     ...
     * Sets enrolments
     *
     * @param \OpenAPI\Client\Model\PersonCoursesResponseEnrolmentsInner[]|null $enrolments enrolments
     *
     * @return self
     */
    ...
    {
        return $this->container['teaching'];
    }

    /**
     * Sets teaching
     *
     * @param \OpenAPI\Client\Model\EvaluationCoursesInner[]|null $teaching teaching
     *
     * @return self
     */
    ...
    {
        if (is_null($teaching)) {
            throw new \InvalidArgumentException('non-nullable teaching cannot be null');
        }
        $this->container['teaching'] = $teaching;
