...
/**
 * CourseTeacher Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CourseTeacher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourseTeacher';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ist_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['ist_id'];
    }

    /**
     * Sets ist_id
     *
     * @param string|null $ist_id ist_id
     *
     * @return self
     */
    public function setIstId($ist_id)
    {
        if (is_null($ist_id)) {
            throw new \InvalidArgumentException('non-nullable ist_id cannot be null');
        }
        $this->container['ist_id'] = $ist_id;
